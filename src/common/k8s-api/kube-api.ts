...
import { KubeObjectConstructor, KubeObject, KubeStatus, isKubeStatusData, KubeJsonApiDataFor, KubeObjectConstructorData, KubeObjectMetadata, KubeObjectScope } from "./kube-object";
